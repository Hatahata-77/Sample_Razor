...
{
	public class HRTagHelperBase : TagHelper
	{

		//	memo:もっと簡単に書けそうな気がするけどコレはうまくいかなかった 使い方間違ってる？
		//	output.Attributes.Append(new TagHelperAttribute("class", strClass));

		public void SetClass(ref TagHelperOutput output, string strClass)
		{
		...
		public void SetStyle(ref TagHelperOutput output, string strStyle)
		{
		...
		public void SetAttribute(ref TagHelperOutput output, string key, string value)
		{
			var objStyle = output.Attributes.FirstOrDefault(a => a.Name == key);
			if (objStyle == null)
			{
